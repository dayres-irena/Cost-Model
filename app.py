...
st.markdown("<h3 style='text-align: center;font-family:Calibri;font-weight: 500;'>IRENA Solar PV Manufacturing Cost Tool</h3>", unsafe_allow_html=True)
st.markdown("")
st.markdown("<h3 style='text-align:center;background-color:#0073AB;font-family:Calibri;font-weight: 500;color:white;padding-left:25px;padding-right:25px;'>About the IRENA Solar PV Manufacturing Cost Tool</h3>", unsafe_allow_html=True)
