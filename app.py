...
st.markdown("")
st.markdown("<h3 style='text-align:center;background-color:#0073AB;font-family:Aptos;font-weight: 600;color:white;padding-left:25px;padding-right:25px;'>About the IRENA Solar PV Manufacturing Cost Tool</h3>", unsafe_allow_html=True)
st.markdown(f"""<p style='background-color:#0073AB;padding-left:25px;padding-right:25px;padding-bottom:25px;font-family:Aptos;color:white'>
